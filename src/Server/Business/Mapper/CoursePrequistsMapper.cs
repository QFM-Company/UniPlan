...
namespace Business.Mapper
{
    public static class CoursePrequistsMapper
    {
        ...
        {
            return new CoursePrerequisites(prequistID, new Course(request.CourseID, null, 0 , null , 0), new Course(request.PreRequestCourseID, null, 0, null , 0));
        }

        public static void UpdateCourse(this CoursePrerequisites coursePrequist, CoursePrerequisiteRequest request)
        {
            coursePrequist.Course = new Course(request.CourseID, null, 0, null , 0);
            coursePrequist.PreRequestCourse = new Course(request.PreRequestCourseID, null, 0, null , 0);
        }
