...
2. **Open the Solution**: Load the `UniPlan.sln` file into Visual Studio.
3. **Database Configuration**: Ensure you have SQL Server running and update your connection strings in `appsettings.json` to match your local environment.
4. **Run the Application**: Build and run the server-side solution from within Visual Studio.
...
* **Pull Requests**: Please ensure your code follows the existing project style and includes relevant documentation.
